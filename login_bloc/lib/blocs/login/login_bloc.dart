...
import 'package:login_bloc/blocs/authentication/authentication_bloc.dart';
import 'package:login_bloc/blocs/authentication/authentication_event.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  Stream<LoginState> _mapLoginWithEmailToState(LoginInWithEmailButtonPressed event) async* {
    ...
    try {
      ...
      yield LoginFailure(error: err.message ?? 'An unknown error occurred');
    }
  }
}
